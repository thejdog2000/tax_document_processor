...
| `02_UI` | Partial | Tkinter shell is incremental; interactive web-style prototype and port task exist; reviewer correction workflow is not ready. |
...
| `05_Architecture` | Pending decision | UI shell, Python bridge, desktop-direct Bedrock vs backend service still need product/architecture decisions. |
